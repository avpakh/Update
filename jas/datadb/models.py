...
class GraphData(models.Model):
    ...
    value_avgBC1=models.DecimalField('Превышение над бровкой от 0 -  50 см',null=True,max_digits=6,decimal_places=3)
    value_avgBC2=models.DecimalField('Превышение над бровкой от 50 до 80 см',null=True,max_digits=6,decimal_places=3)
    value_avgBC3=models.DecimalField('Превышение над бровкой от 80 см до 2 м',null=True,max_digits=6,decimal_places=3)
